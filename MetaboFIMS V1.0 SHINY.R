# MetaboFIMS V1.0.R SHINY application. Please make sure MetaboFIMS V1.0.R is located in the specified directories.
packages <- list(
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("ppm_tolerance_annotation", "PPM tolerance (annotation)", value = 10, min = 0, step = 1),
      hr(),
